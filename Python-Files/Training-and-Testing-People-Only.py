...
def calc_rpn(C, img_data, width, height, resized_width, resized_height, img_length_calc_function):
	...
	for bbox_num, bbox in enumerate(img_data['bboxes']):
		...
		gt_h = gta[bbox_num, 3] - gta[bbox_num, 2]
		gt_w = gta[bbox_num, 1] - gta[bbox_num, 0]
				...
				for yj in range(output_height):
					...
					for bbox_num in range(num_bboxes):
						...
						if curr_iou > best_iou_for_bbox[bbox_num] or curr_iou > C.rpn_max_overlap:
							...
							# cxa, cya are the center point of anchor bbox (cxa = downscale * (ix + 0.5); cya = downscale * (iy + 0.5))
							# w, h are the width and height of ground-truth bbox
							# wa, ha are the width and height of anchor bboxe
							# tx = (cx - cxa) / wa
							# ty = (cy - cya) / ha
							# tw = calculated using locally constrained regression loss
							# th = calculated using locally constrained regression loss
							tx = (cx - cxa) / (x2_anc - x1_anc)
							ty = (cy - cya) / (y2_anc - y1_anc)

							w = gta[bbox_num, 1] - gta[bbox_num, 0]
							h = gta[bbox_num, 3] - gta[bbox_num, 2]
							wa = x2_anc - x1_anc
							ha = y2_anc - y1_anc

							tw = 0
							threshold_w = mu_w * w + 3 * sigma_w * w
							...
							th = 0
							threshold_h = mu_h * h + 3 * sigma_h * h
...
base_path = 'drive/MyDrive/AI/RPN_People'
train_path = '/content/drive/MyDrive/AI/Dataset/Crowd Counting/train_annotation_people.txt'
...
test_base_path = 'drive/MyDrive/AI/Dataset/Crowd Counting/test_people'
test_annotation_path = 'drive/MyDrive/AI/Dataset/Crowd Counting/train_annotation_people.txt'
